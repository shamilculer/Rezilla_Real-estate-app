  ...
  return (
    <>
      <div className="h-screen w-full flex">
        ...
        <div style={{backgroundImage : `url(${loginBg})`}} className="w-0 lg:w-1/2 h-full flex-col justify-center items-centerbg-primary-colour bg-cover bg-center bg-no-repeat"></div>
